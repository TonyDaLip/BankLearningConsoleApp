...
{
    internal class TakeALoanCommandFactory : ICommandFactory
    {
        private readonly OperationProcessor _operationProcessor;
        private readonly ClientManager _clientManager;

        public TakeALoanCommandFactory(OperationProcessor operationProcessor, ClientManager clientManager)
        {
            _operationProcessor = operationProcessor;
            _clientManager = clientManager;
        }

        public string CommandName => "TakeALoan";
        ...
        public ICommand Create(Request request)
        {
            ...
            return new OperationCommand<TakeALoanOperation>(_operationProcessor, new TakeALoanOperation(client, amount, strategy, termInMonths));
        }
    }
}
